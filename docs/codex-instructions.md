# ChatGPT Codex Instructions for TutorDex MonoRepo
...
Authoritative system state: see `docs/SYSTEM_INTERNAL.md` for a detailed, up-to-date description of how the codebase actually behaves. Keep `docs/SYSTEM_INTERNAL.md` in sync with code changes — update it whenever you change extraction, persistence, or distribution behavior. Use `codex-instructions.md` for quick developer guidance and workflows; prefer `docs/SYSTEM_INTERNAL.md` when you need the canonical, operational picture.
