...
# Bootstrap: backfill N days of Telegram history into Supabase (staging),
# enqueue extraction jobs, and drain the queue WITHOUT broadcast/DM side-effects.
#
# Usage:
#   ./scripts/bootstrap_backfill_30d_staging.sh         # defaults to 30 days
#   ./scripts/bootstrap_backfill_30d_staging.sh 60      # backfill 60 days
