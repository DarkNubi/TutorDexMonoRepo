...
LEVELS = [
    "Pre-School", "Primary", "Secondary", "IGCSE", "International Baccalaureate",
...
SPECIFIC_LEVELS = {{
    ...
    "International Baccalaureate": ["IB MYP Grade 6", "IB MYP Grade 7", "IB MYP Grade 8", "IB MYP Grade 9", "IB MYP Grade 10", "IB DP Year 1", "IB DP Year 2"],
